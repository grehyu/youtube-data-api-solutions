...
# Gloabals
DEVELOPER_KEY = input('DEVELOPER_KEY >>> ')
...
# Make a request and the data list of the uploaded videos from that playlist
videos = []    
part = 'snippet'
fields = {
...
with open(f'list-videos-from-{channel_title}.csv', 'w', newline='', encoding='utf-16') as list_videos:
